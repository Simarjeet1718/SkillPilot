...
const CourseCard = ({course}) => {
  ...
  return (
    <div className='shadow rounded-2xl'>
      <Image src={course?.BannerImageUrl} alt={course?.name} width={400} height={400}
      ...
      <div className='p-3 flex flex-col gap-5'>
        ...
        <div className='flex justify-between items-center'>
            <h2 className='flex items-center text-sm gap-2'><Book className='text-primary h-4'/>{courseJson?.noOfChapters} Chapters</h2>
